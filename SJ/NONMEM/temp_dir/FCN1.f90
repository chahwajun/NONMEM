...
! INTEGER
      ...
      USE PRDDESLVU,     ONLY: YPOINTER2,DYPOINTER2
! REAL
...
!      
      ...
      REAL(KIND=DPSIZE),   INTENT(OUT), TARGET    :: YPRIME(*)
      REAL(KIND=DPSIZE),   INTENT(IN OUT) :: T
      REAL(KIND=DPSIZE),   INTENT(IN OUT), TARGET :: Y(*)
...
!
      ...
      INTEGER(KIND=ISIZE) :: AXI,I,IP,IXI,J,JJ,JJY,K,L,LL,LLY,NN,TXI,MAXNY=0
!
...
!          WRITE(*,*) 'HERE FULL'
!          DET(1:NCM1)=0.0D+00
!          DA(1:NCM1,1:NCM1)=0.0D+00
!          DP(1:NCM1,1:NBP)=0.0D+00
