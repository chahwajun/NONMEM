...
;; 2. Description: SB vitreous with IIV CL V without error
...
$TABLE ID TIME DV MDV CMT AMT LEFT SITE DAY WEEK IWRES IRES IPRED CWRES                                          NOPRINT ONEHEADER          FILE=sdtab8
$TABLE ID CL V ETA1 ETA2                                                                                        NOPRINT ONEHEADER NOAPPEND FILE=patab8
