;; 1. Based on: 1
$PROBLEM SB vitreous 2comp with no error model 
...
$TABLE ID TIME DV MDV CMT AMT LEFT SITE DAY WEEK IWRES IRES IPRED CWRES                                          NOPRINT ONEHEADER          FILE=sdtab25
$TABLE ID CL V1 V2 Q ETA1 ETA2 ETA3 ETA4                                                                                         NOPRINT ONEHEADER NOAPPEND FILE=patab25
